...
exports.RulesModule = RulesModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: expert_rule_schema_1.ExpertRule.name, schema: expert_rule_schema_1.ExpertRuleSchema }])],
        providers: [rules_repository_1.RulesRepository, rules_service_1.RulesService],
