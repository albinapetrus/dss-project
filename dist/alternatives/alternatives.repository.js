...
exports.AlternativesRepository = void 0;
const common_1 = require("@nestjs/common");
const mongoose_1 = require("@nestjs/mongoose");
const mongoose_2 = require("mongoose");
const alternative_schema_1 = require("./alternative.schema");
let AlternativesRepository = class AlternativesRepository {
    constructor(alternativeModel) {
...
exports.AlternativesRepository = AlternativesRepository;
exports.AlternativesRepository = AlternativesRepository = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)(alternative_schema_1.Alternative.name)),
    __metadata("design:paramtypes", [mongoose_2.Model])
], AlternativesRepository);
//# sourceMappingURL=alternatives.repository.js.map